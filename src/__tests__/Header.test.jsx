...
const { useStore, setLanguage } = require('../store');
...
describe('Header Component', () => {
  ...
  test('renders hamburger menu button', () => {
    ...
    const hamburgerButton = hamburgerButtons.find(btn => 
      btn.className.includes('header__hamburger')
    );
    ...
    expect(hamburgerIcon).toHaveAttribute('src', '/images/Icon.png');
  });
  ...
  test('language buttons call dispatch when clicked', () => {
    renderHeader();
